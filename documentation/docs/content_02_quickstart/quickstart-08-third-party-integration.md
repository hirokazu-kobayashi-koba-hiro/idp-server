...
OAuth 2.0の認可コードフローを使って、サードパーティアプリにユーザーのデータへのアクセスを許可します。

**例**:
- **あなたが運営**: ファイル保存サービス → **外部アプリ**: スマホアプリがユーザーのファイルを表示・編集
- **あなたが運営**: タスク管理サービス → **外部アプリ**: Slackボットがユーザーのタスクを通知
- **あなたが運営**: 写真投稿サービス → **外部アプリ**: 写真編集ツールがユーザーの写真を加工
