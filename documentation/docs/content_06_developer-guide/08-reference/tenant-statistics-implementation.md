...
このドキュメントでは、テナント統計機能の実装詳細について説明します。概要については [テナント統計管理](../../content_03_concepts/concept-22-tenant-statistics.md) を参照してください。
...
- [テナント統計管理](../../content_03_concepts/concept-22-tenant-statistics.md) - 概念・API仕様
...
- [セキュリティイベント・フック](../../content_03_concepts/concept-17-security-events.md) - イベント駆動アーキテクチャ
