...
| 05b | [EKS Auto Scaling](02-computing/aws-eks-autoscaling.md) | HPA、VPA、Karpenter、Cluster Autoscaler、KEDA、IDサービス向け設計 | 60分 |
...
| 11 | [API Gateway](04-networking/aws-api-gateway.md) | スロットリング、使用量プラン、APIキー、WAFとの多層防御 | 40分 |

### セキュリティ・監視

| # | ドキュメント | 内容 | 所要時間 |
|---|-------------|------|---------|
| 12 | [セキュリティサービス](05-security-monitoring/aws-security-services.md) | KMS、Secrets Manager、WAF、Shield、GuardDuty | 45分 |
| 13 | [モニタリング](05-security-monitoring/aws-monitoring.md) | CloudWatch、CloudTrail、Kinesis Firehose、X-Ray、AWS Config | 45分 |

### 運用・設計

| # | ドキュメント | 内容 | 所要時間 |
|---|-------------|------|---------|
| 14 | [Infrastructure as Code](06-operations/aws-iac.md) | CloudFormation、CDK、SAM、テンプレート構文 | 45分 |
| 15 | [Well-Architected Framework](06-operations/aws-well-architected.md) | 6つの柱、設計原則、レビュープロセス、本番コスト試算 | 45分 |
| 16 | [Well-Architected: 大量データの設計パターン](06-operations/aws-well-architected-large-scale.md) | データ分類、パフォーマンス、信頼性、コスト最適化、Phase別コスト試算 | 70分 |
| 17 | [コスト最適化](06-operations/aws-cost-optimization.md) | Right Sizing、Savings Plans/RI、Graviton移行、コスト監視 | 45分 |
...
| [Kubernetes](../13-docker-kubernetes/README.md) | EKSで利用するK8sの基礎知識 |
