...
## 目次
1. [サーバーレスとは何か](#サーバーレスとは何か)
2. [Lambda概要](#lambda概要)
3. [Lambda関数の作成](#lambda関数の作成)
4. [Lambdaのコールドスタートと対策](#lambdaのコールドスタートと対策)
5. [Lambdaの制限と料金モデル](#lambdaの制限と料金モデル)
6. [API Gateway](#api-gateway)
7. [API Gateway + Lambda 統合パターン](#api-gateway--lambda-統合パターン)
8. [SQS（Simple Queue Service）](#sqssimple-queue-service)
9. [SNS（Simple Notification Service）](#snssimple-notification-service)
10. [EventBridge](#eventbridge)
11. [Kinesis Data Streams](#kinesis-data-streams)
12. [Kinesis Data Firehose](#kinesis-data-firehose)
13. [Step Functions](#step-functions)
14. [IDサービスでの活用](#idサービスでの活用)
15. [まとめ](#まとめ)
