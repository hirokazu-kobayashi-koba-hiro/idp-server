...
public class DynamicRegistrationController {
    ...
    public ResponseEntity<ClientRegistrationResponse> register(
        ...
        Instant expiresAt = issuedAt.plus(Duration.ofDays(365));
        ...
        return ResponseEntity.status(HttpStatus.CREATED)
            .body(ClientRegistrationResponse.builder()
                ...
                .clientIdIssuedAt(issuedAt.getEpochSecond())
                .clientSecretExpiresAt(expiresAt.getEpochSecond())
                ...
                .registrationClientUri(
                    "https://auth.example.com/register/" + clientId)
                .build());
    }
}
```
...
async function registerClient() {
  ...
  // 登録情報を安全に保存
  saveClientCredentials(clientInfo);
