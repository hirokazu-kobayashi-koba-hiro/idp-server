...
| 10 | [dba-10-procarraylock-internals.md](dba-10-procarraylock-internals.md) | ProcArrayLock と LWLock の内部メカニズム |
| 11 | [dba-11-row-level-security.md](dba-11-row-level-security.md) | Row Level Security (RLS) 完全ガイド |
| 12 | [dba-12-index-lifecycle.md](dba-12-index-lifecycle.md) | インデックスのライフサイクル（CREATE/DROP/REINDEX 本番運用） |
...
| 09 | [dev-09-cpu-consumption.md](dev-09-cpu-consumption.md) | CPU 消費パターン（JSONB / GIN / index / RLS / autovacuum 等）|
| 10 | [dev-10-throughput-and-latency.md](dev-10-throughput-and-latency.md) | スループットとレイテンシの関係（待ち行列、使用率の影響、ホッケースティック曲線）|
...
9. **dba-10-procarraylock-internals.md** - 接続スケーラビリティの内部メカニズム
