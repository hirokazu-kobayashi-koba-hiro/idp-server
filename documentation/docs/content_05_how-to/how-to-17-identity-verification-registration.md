...
**外部で身元確認済みのデータを直接登録し、verified_claimsとしてユーザーに紐付ける**ことが目標です。

### 学べること

✅ **身元確認データ登録の基礎**
- テンプレート定義の構造
- verified_claimsへのマッピング設定
- JSON Schemaによる検証
...
### 前提条件
- [how-to-15: 身元確認導入ガイド](./how-to-15-identity-verification-guide.md)を読了
- テナント作成完了
- 身元確認済みデータが外部で担保されている
