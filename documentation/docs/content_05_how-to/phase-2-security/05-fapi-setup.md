...
curl -X PUT "https://api.local.test/v1/management/tenants/{tenant-id}/authorization-server" \
  ...
  -d '{
    "issuer": "https://api.local.test/{tenant-id}",
    "authorization_endpoint": "https://api.local.test/{tenant-id}/v1/authorizations",
    "token_endpoint": "https://api.local.test/{tenant-id}/v1/tokens",
    "userinfo_endpoint": "https://api.local.test/{tenant-id}/v1/userinfo",
    "jwks_uri": "https://api.local.test/{tenant-id}/v1/jwks",
    "pushed_authorization_request_endpoint": "https://api.local.test/{tenant-id}/v1/authorizations/push",
    "mtls_endpoint_aliases": {
      "token_endpoint": "https://mtls.api.local.test/{tenant-id}/v1/tokens",
      "userinfo_endpoint": "https://mtls.api.local.test/{tenant-id}/v1/userinfo",
      "pushed_authorization_request_endpoint": "https://mtls.api.local.test/{tenant-id}/v1/authorizations/push",
      "introspection_endpoint": "https://mtls.api.local.test/{tenant-id}/v1/tokens/introspection",
      "revocation_endpoint": "https://mtls.api.local.test/{tenant-id}/v1/tokens/revocation"
    },
...
```bash
curl -X POST "https://api.local.test/v1/management/tenants/{tenant-id}/clients" \
  -H "Authorization: Bearer ${ADMIN_TOKEN}" \
  -H "Content-Type: application/json" \
  -d '{
...
通常エンドポイント（認可リクエスト、Discovery等）:
  https://api.local.test/{tenant-id}/v1/authorizations
  https://api.local.test/{tenant-id}/.well-known/openid-configuration

mTLSエンドポイント（トークン発行、リソースアクセス等）:
  https://mtls.api.local.test/{tenant-id}/v1/tokens
  https://mtls.api.local.test/{tenant-id}/v1/authorizations/push
```
