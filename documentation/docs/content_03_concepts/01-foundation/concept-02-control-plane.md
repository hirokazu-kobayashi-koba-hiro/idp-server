...
- 属性マッピングの定義
- 詳細: [ID管理](../02-identity-management/concept-01-id-management.md)

### 6. 認証設定
- 認証方式（パスワード、MFA、FIDO2等）の有効化・無効化
- 認証ポリシーの設定
- 詳細: [認証ポリシー](../03-authentication-authorization/concept-01-authentication-policy.md), [MFA](../03-authentication-authorization/concept-02-mfa.md)
...
- [マルチテナント](concept-03-multi-tenant.md) - テナント・組織の概念
- [認証ポリシー](../03-authentication-authorization/concept-01-authentication-policy.md) - 認証制御
- [トークン管理](../04-tokens-claims/concept-02-token-management.md) - トークン設定
