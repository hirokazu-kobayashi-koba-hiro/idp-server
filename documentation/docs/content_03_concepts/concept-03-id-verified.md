...
- [CIBA](../content_04_protocols/ciba-flow.md) - バックチャネル認証フロー
...
1. 身元確認の申込みから利用するパターン [詳細](../content_05_how-to/how-to-07-identity-verification-application.md)
2. 身元確認結果を直接登録するパターン [詳細](../content_05_how-to/how-to-10-identity-verification-registration.md)
...
- [CIBA](../content_04_protocols/ciba-flow.md) - バックチャネル認証での身元確認要求
- [マルチテナント](multi-tenant.md) - テナント別の身元確認設定
- [エンタープライズID](enterprise-id.md) - 企業での身元確認統合
- [身元確認申込み設定](../content_05_how-to/how-to-07-identity-verification-application.md) - 外部サービス連携設定
- [身元確認結果登録](../content_05_how-to/how-to-10-identity-verification-registration.md) - 直接登録設定
