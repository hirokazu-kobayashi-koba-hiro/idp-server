...
- [監査ログ](concept-01-audit-compliance.md) - AuditLog、SecurityEventとの違い
- [運用・保守](concept-04-operations.md) - 運用における位置づけ
...
- [監査ログ](concept-01-audit-compliance.md) - AuditLog、SecurityEvent、3種類のログの違い
- [セキュリティイベント](../06-security-extensions/concept-01-security-events.md) - SecurityEvent詳細
- [運用・保守](concept-04-operations.md) - ヘルスチェック、メトリクス
