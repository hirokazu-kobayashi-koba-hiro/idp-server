...
- [身元確認済みID](../05-advanced-id/concept-01-id-verified.md) - 身元確認プロセスの概要
- [外部サービス連携](concept-02-external-service-integration.md) - 外部API連携の仕組み
- [認証ポリシー](../03-authentication-authorization/concept-01-authentication-policy.md) - 認証フローの設定
