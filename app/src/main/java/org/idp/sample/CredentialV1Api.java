...
public class CredentialV1Api implements ParameterTransformable, VerifiableCredentialDelegate {
  ...
  public CredentialV1Api(IdpServerApplication idpServerApplication, UserMockService userMockService) {
  ...
  public ResponseEntity<?> post(
    ...
    CredentialRequest credentialRequest = new CredentialRequest(authorizationHeader, params, tenant.issuer());
  ...
  @Override
  public VerifiableCredential getCredential(TokenIssuer tokenIssuer, Subject subject, List<CredentialDefinition> credentialDefinitions) {
    String vc = """
            {
                "@context": [
