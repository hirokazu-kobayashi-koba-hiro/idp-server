...
public class ExternalApiAuthenticationInteractorFactory implements AuthenticationInteractorFactory {
  ...
  public AuthenticationInteractor create(AuthenticationDependencyContainer container) {
    ...
    return new ExternalApiAuthenticationInteractor(configurationRepository, executors);
  }
}
