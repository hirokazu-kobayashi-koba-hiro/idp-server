...
public class EmailChallengeAuthenticationExecutorFactory implements AuthenticationExecutorFactory {
  ...
  public AuthenticationExecutor create(AuthenticationDependencyContainer container) {
    ...
    return new EmailChallengeAuthenticationExecutor(
        interactionCommandRepository, interactionQueryRepository, emailSenders);
  }
}
