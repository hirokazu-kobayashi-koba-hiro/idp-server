...
public class InternalSmsAuthenticationExecutorFactory implements SmsAuthenticationExecutorFactory {
  ...
  public SmsAuthenticationExecutor create(AuthenticationDependencyContainer container) {
    ...
    SmsSenders smsSenders = container.resolve(SmsSenders.class);
    return new InternalSmsAuthenticationExecutor(
        interactionCommandRepository, interactionQueryRepository, smsSenders);
  }
}
