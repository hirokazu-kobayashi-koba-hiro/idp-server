...
public class AuthenticationDeviceNumberMatchingChallengeInteractorFactory
  ...
  public AuthenticationInteractor create(AuthenticationDependencyContainer container) {
    ...
    return new AuthenticationDeviceNumberMatchingChallengeInteractor(
        configurationQueryRepository, interactionCommandRepository);
  }
}
