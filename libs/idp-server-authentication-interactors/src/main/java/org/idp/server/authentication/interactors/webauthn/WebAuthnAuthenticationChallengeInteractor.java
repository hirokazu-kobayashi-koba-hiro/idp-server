...
public class WebAuthnAuthenticationChallengeInteractor implements AuthenticationInteractor {
  ...
  LoggerWrapper log = LoggerWrapper.getLogger(WebAuthnAuthenticationChallengeInteractor.class);
  ...
  public AuthenticationInteractionRequestResult interact(
    ...
    AuthenticationInteractionConfig authenticationInteractionConfig =
        configuration.getAuthenticationConfig("webauthn-authentication-challenge");
    ...
    if (executionResult.isClientError()) {
      return AuthenticationInteractionRequestResult.clientError(
          ...
          operationType(),
          method(),
          DefaultSecurityEventType.webauthn_authentication_challenge_failure);
    }
    ...
    return new AuthenticationInteractionRequestResult(
        ...
        transaction.user(),
        executionResult.contents(),
        DefaultSecurityEventType.webauthn_authentication_challenge_success);
  }
}
