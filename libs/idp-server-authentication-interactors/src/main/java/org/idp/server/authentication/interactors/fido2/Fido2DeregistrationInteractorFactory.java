...
public class Fido2DeregistrationInteractorFactory implements AuthenticationInteractorFactory {
  ...
  public AuthenticationInteractor create(AuthenticationDependencyContainer container) {
    ...
    return new Fido2DeregistrationInteractor(configurationRepository, authenticationExecutors);
  }
}
