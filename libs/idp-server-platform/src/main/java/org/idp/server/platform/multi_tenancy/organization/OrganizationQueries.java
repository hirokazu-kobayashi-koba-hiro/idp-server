...
public class OrganizationQueries implements UuidConvertable {
  Map<String, String> values;

  public OrganizationQueries() {}

  public OrganizationQueries(Map<String, String> values) {
    this.values = Objects.requireNonNullElseGet(values, HashMap::new);
  }

  public static OrganizationQueries ids(Set<String> organizationIds) {
    OrganizationQueries queries = new OrganizationQueries();
    queries.values = new HashMap<>();
    queries.values.put("ids", String.join(",", organizationIds));
    return queries;
  }
  ...
  public List<String> ids() {
    ...
    return List.of(values.get("ids").split(","));
  }
