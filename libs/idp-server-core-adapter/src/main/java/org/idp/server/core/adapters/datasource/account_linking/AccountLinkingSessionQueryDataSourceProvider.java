...
public class AccountLinkingSessionQueryDataSourceProvider
    implements ApplicationComponentProvider<AccountLinkingSessionQueryRepository> {

  @Override
  public Class<AccountLinkingSessionQueryRepository> type() {
    return AccountLinkingSessionQueryRepository.class;
  }
