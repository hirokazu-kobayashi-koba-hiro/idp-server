...
public class UserKnownDeviceCommandDataSource implements UserKnownDeviceCommandRepository {

  UserKnownDeviceCommandSqlExecutor executor;

  public UserKnownDeviceCommandDataSource(UserKnownDeviceCommandSqlExecutor executor) {
    this.executor = executor;
  }

  @Override
  public void upsert(Tenant tenant, UserKnownDevice userKnownDevice) {
    executor.upsert(tenant, userKnownDevice);
  }
}
