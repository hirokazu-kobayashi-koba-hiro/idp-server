...
public class DailyActiveUserQueryDataSource implements DailyActiveUserQueryRepository {

  DailyActiveUserSqlExecutor executor;

  public DailyActiveUserQueryDataSource(DailyActiveUserSqlExecutor executor) {
    this.executor = executor;
  }

  @Override
  public int getDauCount(TenantIdentifier tenantId, LocalDate date) {
    return executor.getDauCount(tenantId, date);
  }
}
