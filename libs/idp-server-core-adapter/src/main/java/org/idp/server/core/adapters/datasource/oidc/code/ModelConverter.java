...
class ModelConverter {
  ...
  static AuthorizationCodeGrant convert(Map<String, String> stringMap) {
    AuthorizationRequestIdentifier id = new AuthorizationRequestIdentifier(stringMap.get("authorization_request_id"));
    ...
    AuthorizationCode authorizationCode = new AuthorizationCode(stringMap.get("authorization_code"));
