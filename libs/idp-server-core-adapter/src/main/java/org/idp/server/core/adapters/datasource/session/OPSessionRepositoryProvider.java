...
public class OPSessionRepositoryProvider
    implements ApplicationComponentProvider<OPSessionRepository> {

  @Override
  public Class<OPSessionRepository> type() {
    return OPSessionRepository.class;
  }
