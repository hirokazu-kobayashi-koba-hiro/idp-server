...
public interface DeviceCredentialQuerySqlExecutor {

  Map<String, String> selectById(Tenant tenant, DeviceCredentialIdentifier credentialId);

  List<Map<String, String>> selectByDeviceId(
      Tenant tenant, AuthenticationDeviceIdentifier deviceId);

  Map<String, String> selectActiveByDeviceId(
      Tenant tenant, AuthenticationDeviceIdentifier deviceId);

  Map<String, String> selectActiveByDeviceIdAndAlgorithm(
