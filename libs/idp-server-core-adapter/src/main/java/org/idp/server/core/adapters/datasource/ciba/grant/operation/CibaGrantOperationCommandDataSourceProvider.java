...
public class CibaGrantOperationCommandDataSourceProvider
    implements ApplicationComponentProvider<CibaGrantOperationCommandRepository> {

  @Override
  public Class<CibaGrantOperationCommandRepository> type() {
    return CibaGrantOperationCommandRepository.class;
  }
