...
public class RiskAssessmentConfigurationCommandDataSource
    implements RiskAssessmentConfigurationCommandRepository {

  RiskAssessmentConfigCommandSqlExecutor executor;

  public RiskAssessmentConfigurationCommandDataSource(
      RiskAssessmentConfigCommandSqlExecutor executor) {
    this.executor = executor;
  }

  @Override
  public void register(Tenant tenant, RiskAssessmentConfig configuration) {
