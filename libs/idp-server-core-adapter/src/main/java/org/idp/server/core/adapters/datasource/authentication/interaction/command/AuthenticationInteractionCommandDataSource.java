...
public class AuthenticationInteractionCommandDataSource implements AuthenticationInteractionCommandRepository {
  ...
  @Override
  public <T> void register(Tenant tenant, AuthorizationIdentifier identifier, String type, T payload) {
