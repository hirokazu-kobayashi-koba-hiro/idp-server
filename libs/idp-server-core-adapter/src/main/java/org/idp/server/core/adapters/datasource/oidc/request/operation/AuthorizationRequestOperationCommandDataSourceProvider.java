...
public class AuthorizationRequestOperationCommandDataSourceProvider
    implements ApplicationComponentProvider<AuthorizationRequestOperationCommandRepository> {

  @Override
  public Class<AuthorizationRequestOperationCommandRepository> type() {
    return AuthorizationRequestOperationCommandRepository.class;
  }
