...
public class LinkedExternalAccountCommandDataSourceProvider
    implements ApplicationComponentProvider<LinkedExternalAccountCommandRepository> {

  @Override
  public Class<LinkedExternalAccountCommandRepository> type() {
    return LinkedExternalAccountCommandRepository.class;
  }

  @Override
  public LinkedExternalAccountCommandRepository provide(
