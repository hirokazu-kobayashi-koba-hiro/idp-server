...
public class AccountLinkingSessionCommandDataSourceProvider
    implements ApplicationComponentProvider<AccountLinkingSessionCommandRepository> {

  @Override
  public Class<AccountLinkingSessionCommandRepository> type() {
    return AccountLinkingSessionCommandRepository.class;
  }

  @Override
  public AccountLinkingSessionCommandRepository provide(
