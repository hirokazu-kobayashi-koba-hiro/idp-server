...
public class DeviceCredentialCommandDataSource implements DeviceCredentialCommandRepository {

  DeviceCredentialCommandSqlExecutor executor;

  public DeviceCredentialCommandDataSource(DeviceCredentialCommandSqlExecutor executor) {
  ...
  public void deleteByDeviceId(Tenant tenant, AuthenticationDeviceIdentifier deviceId) {
    executor.deleteByDeviceId(tenant, deviceId);
  }
}
