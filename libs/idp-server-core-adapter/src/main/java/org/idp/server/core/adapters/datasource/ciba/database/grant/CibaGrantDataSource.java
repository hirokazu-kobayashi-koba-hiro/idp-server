...
public class CibaGrantDataSource implements CibaGrantRepository {
  ...
  public void register(CibaGrant cibaGrant) {
    ...
    String sqlTemplate =
        """
                    ...
                    (backchannel_authentication_request_id, tenant_id, auth_req_id, expired_at, interval, status, user_id, user_payload, authentication, client_id, client_payload, scopes, id_token_claims, userinfo_claims, custom_properties, authorization_details)
  ...
  public CibaGrant find(AuthReqId authReqId) {
    ...
    String sqlTemplate =
        """
            SELECT backchannel_authentication_request_id, tenant_id, auth_req_id, expired_at, interval, status, user_id, user_payload, authentication, client_id, client_payload, scopes, id_token_claims, userinfo_claims, custom_properties, authorization_details
            FROM ciba_grant
            WHERE auth_req_id = ?;
            """;
