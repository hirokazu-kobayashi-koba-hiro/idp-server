...
public class PermissionQueryDataSourceProvider
    implements ApplicationComponentProvider<PermissionQueryRepository> {

  @Override
  public Class<PermissionQueryRepository> type() {
    return PermissionQueryRepository.class;
  }

  @Override
  public PermissionQueryRepository provide(ApplicationComponentDependencyContainer container) {
    ...
    return new PermissionQueryDataSource(executor);
  }
}
