...
public class AuthorizationCodeGrantOperationCommandDataSourceProvider
    implements ApplicationComponentProvider<AuthorizationCodeGrantOperationCommandRepository> {

  @Override
  public Class<AuthorizationCodeGrantOperationCommandRepository> type() {
    return AuthorizationCodeGrantOperationCommandRepository.class;
  }

  @Override
  public AuthorizationCodeGrantOperationCommandRepository provide(
    ...
    return new AuthorizationCodeGrantOperationCommandDataSource(executor);
  }
}
