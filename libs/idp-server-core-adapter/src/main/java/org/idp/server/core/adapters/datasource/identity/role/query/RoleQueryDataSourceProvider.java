...
public class RoleQueryDataSourceProvider
    implements ApplicationComponentProvider<RoleQueryRepository> {

  @Override
  public Class<RoleQueryRepository> type() {
    return RoleQueryRepository.class;
  }
