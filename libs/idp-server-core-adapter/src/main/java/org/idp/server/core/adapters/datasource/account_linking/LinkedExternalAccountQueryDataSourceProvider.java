...
public class LinkedExternalAccountQueryDataSourceProvider
    implements ApplicationComponentProvider<LinkedExternalAccountQueryRepository> {

  @Override
  public Class<LinkedExternalAccountQueryRepository> type() {
    return LinkedExternalAccountQueryRepository.class;
  }
