...
public class AuditLogQueryDataSourceProvider
    implements ApplicationComponentProvider<AuditLogQueryRepository> {

  @Override
  public Class<AuditLogQueryRepository> type() {
    return AuditLogQueryRepository.class;
  }

  @Override
  public AuditLogQueryRepository provide(ApplicationComponentDependencyContainer container) {
    ...
    return new AuditLogQueryDataSource(executor);
  }
}
