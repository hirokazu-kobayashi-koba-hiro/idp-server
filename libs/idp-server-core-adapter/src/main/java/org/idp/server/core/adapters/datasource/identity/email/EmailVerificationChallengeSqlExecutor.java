...
public interface EmailVerificationChallengeSqlExecutor {

  void insert(Tenant tenant, EmailVerificationChallenge challenge);
  ...
  void updateAttempts(Tenant tenant, EmailVerificationChallenge challenge);
