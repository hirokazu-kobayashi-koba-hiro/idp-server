...
public class SsoCredentialsCommandDataSourceProvider
    implements FederationDependencyProvider<SsoCredentialsCommandRepository>,
        ApplicationComponentProvider<SsoCredentialsCommandRepository> {

  @Override
  public Class<SsoCredentialsCommandRepository> type() {
    return SsoCredentialsCommandRepository.class;
  }
