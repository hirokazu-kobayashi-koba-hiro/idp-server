...
public class ClientInstanceCommandDataSource implements ClientInstanceCommandRepository {

  ClientInstanceSqlExecutor executor;

  public ClientInstanceCommandDataSource(ClientInstanceSqlExecutor executor) {
    this.executor = executor;
  }

  @Override
  public void register(Tenant tenant, ClientInstance clientInstance) {
    executor.insert(tenant, clientInstance);
  }

  @Override
  public void update(Tenant tenant, ClientInstance clientInstance) {
    executor.update(tenant, clientInstance);
  }
