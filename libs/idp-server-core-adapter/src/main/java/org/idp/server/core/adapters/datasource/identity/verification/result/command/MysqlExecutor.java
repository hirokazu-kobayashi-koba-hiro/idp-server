...
public class MysqlExecutor implements IdentityVerificationResultCommandSqlExecutor {
  ...
  public void insert(Tenant tenant, IdentityVerificationResult result) {
    ...
    String sqlTemplate =
        """
                    INSERT INTO identity_verification_result
                    (
                    id,
                    tenant_id,
                    user_id,
    ...
    params.add(result.userId().value());
