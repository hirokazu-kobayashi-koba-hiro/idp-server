...
public class SecurityEventHoolResultSqlExecutors {
  ...
  Map<DatabaseType, SecurityEventHookResultSqlExecutor> executors;
  ...
  public SecurityEventHookResultSqlExecutor get(DatabaseType databaseType) {
    SecurityEventHookResultSqlExecutor executor = executors.get(databaseType);
