...
public class AuthorizationGrantedQueryDataSourceProvider
    implements ApplicationComponentProvider<AuthorizationGrantedQueryRepository> {

  @Override
  public Class<AuthorizationGrantedQueryRepository> type() {
    return AuthorizationGrantedQueryRepository.class;
  }

  @Override
  public AuthorizationGrantedQueryRepository provide(
    ...
    return new AuthorizationGrantedQueryDataSource(executor);
  }
}
