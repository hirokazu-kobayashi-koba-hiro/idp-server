...
public class SecurityEventQueryDataSourceProvider
    implements ApplicationComponentProvider<SecurityEventQueryRepository> {

  @Override
  public Class<SecurityEventQueryRepository> type() {
    return SecurityEventQueryRepository.class;
  }

  @Override
  public SecurityEventQueryRepository provide(ApplicationComponentDependencyContainer container) {
    ...
    return new SecurityEventQueryDataSource(executor);
  }
}
