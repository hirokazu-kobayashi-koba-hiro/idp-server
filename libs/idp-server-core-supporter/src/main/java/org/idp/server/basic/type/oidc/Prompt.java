 ...
 *
 * <p>
 * none The Authorization Server MUST NOT display any authentication or consent user interface
 ...
 *
 * <p>
 * consent The Authorization Server SHOULD prompt the End-User for consent before returning
 * information to the Client. If it cannot obtain consent, it MUST return an error, typically
 * consent_required.
 *
 * <p>
 * select_account The Authorization Server SHOULD prompt the End-User to select a user account. This
 * enables an End-User who has multiple accounts at the Authorization Server to select amongst the
 ...
 */
public enum Prompt {
  none, login, consent, select_account, create, undefined, unknown;
