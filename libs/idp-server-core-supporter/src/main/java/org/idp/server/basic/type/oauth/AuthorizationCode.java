 ...
 * shortly after it is issued to mitigate the risk of leaks. A maximum authorization code lifetime
 * of 10 minutes is RECOMMENDED. The client MUST NOT use the authorization code more than once. If
 * an authorization code is used more than once, the authorization server MUST deny the request and
