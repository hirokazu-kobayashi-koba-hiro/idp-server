 ...
 *
 * <p>
 * Human-readable ASCII [USASCII] text providing additional information, used to assist the client
 * developer in understanding the error that occurred. Values for the "error_description" parameter
