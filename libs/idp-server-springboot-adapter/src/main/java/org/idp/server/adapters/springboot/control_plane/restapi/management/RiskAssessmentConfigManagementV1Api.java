...
@RestController
@RequestMapping("/v1/management/tenants/{tenant-id}/risk-assessment-configuration")
public class RiskAssessmentConfigManagementV1Api implements ParameterTransformable {

  RiskAssessmentConfigManagementApi riskAssessmentConfigManagementApi;

  public RiskAssessmentConfigManagementV1Api(IdpServerApplication idpServerApplication) {
    this.riskAssessmentConfigManagementApi =
        idpServerApplication.riskAssessmentConfigManagementApi();
  }
  ...
  public ResponseEntity<?> get(
    ...
    RiskAssessmentConfigManagementResponse response =
        riskAssessmentConfigManagementApi.get(
  ...
  public ResponseEntity<?> put(
    ...
    RiskAssessmentConfigManagementResponse response =
        riskAssessmentConfigManagementApi.put(
            operatorPrincipal.authenticationContext(),
            tenantIdentifier,
            new RiskAssessmentConfigRequest(body),
            requestAttributes,
            dryRun);
  ...
  public ResponseEntity<?> delete(
    ...
    RiskAssessmentConfigManagementResponse response =
        riskAssessmentConfigManagementApi.delete(
