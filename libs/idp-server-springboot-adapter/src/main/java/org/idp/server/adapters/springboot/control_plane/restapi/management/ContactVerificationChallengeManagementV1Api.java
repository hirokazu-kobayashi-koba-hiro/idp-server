...
@RestController
@RequestMapping("/v1/management/tenants/{tenant-id}/contact-verification-challenges")
public class ContactVerificationChallengeManagementV1Api implements ParameterTransformable {

  ContactVerificationChallengeManagementApi managementApi;

  public ContactVerificationChallengeManagementV1Api(IdpServerApplication idpServerApplication) {
    this.managementApi = idpServerApplication.contactVerificationChallengeManagementApi();
  }
  ...
  public ResponseEntity<?> get(
      @AuthenticationPrincipal OperatorPrincipal operatorPrincipal,
      @PathVariable("tenant-id") TenantIdentifier tenantIdentifier,
      @PathVariable("id") ContactVerificationChallengeIdentifier identifier,
      HttpServletRequest httpServletRequest) {
