...
@RestController
@RequestMapping("/v1/management/organizations/{organizationId}/tenants/{tenantId}/client-instances")
public class OrganizationClientInstanceManagementV1Api implements ParameterTransformable {

  OrgClientInstanceManagementApi orgClientInstanceManagementApi;

  public OrganizationClientInstanceManagementV1Api(IdpServerApplication idpServerApplication) {
    this.orgClientInstanceManagementApi = idpServerApplication.orgClientInstanceManagementApi();
  }
  ...
  public ResponseEntity<?> post(
    ...
    ClientInstanceManagementResponse response =
        orgClientInstanceManagementApi.create(
  ...
  public ResponseEntity<?> getList(
    ...
    ClientInstanceManagementResponse response =
        orgClientInstanceManagementApi.findList(
            organizationOperatorPrincipal.authenticationContext(),
            new TenantIdentifier(tenantId),
  ...
  public ResponseEntity<?> get(
    ...
    ClientInstanceManagementResponse response =
        orgClientInstanceManagementApi.get(
            organizationOperatorPrincipal.authenticationContext(),
            new TenantIdentifier(tenantId),
  ...
  public ResponseEntity<?> revoke(
    ...
    ClientInstanceManagementResponse response =
        orgClientInstanceManagementApi.revoke(
            organizationOperatorPrincipal.authenticationContext(),
            new TenantIdentifier(tenantId),
            new ClientInstanceIdentifier(id),
            requestAttributes,
  ...
  public ResponseEntity<?> delete(
    ...
    ClientInstanceManagementResponse response =
        orgClientInstanceManagementApi.delete(
            organizationOperatorPrincipal.authenticationContext(),
            new TenantIdentifier(tenantId),
            new ClientInstanceIdentifier(id),
            requestAttributes,
