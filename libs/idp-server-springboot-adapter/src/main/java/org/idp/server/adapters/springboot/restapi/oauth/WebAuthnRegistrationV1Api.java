...
public class WebAuthnRegistrationV1Api {
  ...
  public ResponseEntity<?> getChallenge(
    ...
    OAuthUserInteractionResult result =
        oAuthFlowFunction.interact(tenantIdentifier, id, OAuthUserInteractionType.WEBAUTHN_REGISTRATION_CHALLENGE, Map.of());
  ...
  public ResponseEntity<?> register(
    ...
    OAuthUserInteractionResult result = oAuthFlowFunction.interact(tenantIdentifier, id, OAuthUserInteractionType.WEBAUTHN_REGISTRATION, Map.of("request", request));
