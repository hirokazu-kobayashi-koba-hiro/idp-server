...
class IdentityVerificationUserUpdaterTest {
  ...
  void testDefaultTransitsToIdentityVerified() {
    ...
    User updated =
        IdentityVerificationUserUpdater.update(tenant(), user, context(Map.of()), resultConfig)
            .updated();
  ...
  void testCustomPropertiesMappingMergesWithExistingProperties() {
    ...
    User updated =
        IdentityVerificationUserUpdater.update(
                tenant(), user, context(Map.of("kyc_level", "gold")), resultConfig)
            .updated();
  ...
  void testDisallowedLifecycleTransitionFailsClosed() {
    ...
    assertThrows(
        ...
        () ->
            IdentityVerificationUserUpdater.update(
                tenant(), user, context(Map.of()), resultConfig));
  }
  ...
  void testMissingSourcePathKeepsExistingValues() {
    ...
    User updated =
        IdentityVerificationUserUpdater.update(
                tenant(), user, context(Map.of("first_name", "Hanako")), resultConfig)
            .updated();
  ...
  void testVerifiedClaimsDefaultMergeReplacesTopLevelObjects() {
    ...
    User updated =
        IdentityVerificationUserUpdater.applyVerifiedClaims(
            user, Map.of("claims", Map.of("annual_income", 8000000)), resultConfig);
  ...
  void testVerifiedClaimsDeepMergePreservesExistingClaims() {
    ...
    User updated =
        IdentityVerificationUserUpdater.applyVerifiedClaims(user, produced, resultConfig);
  ...
  void testCustomPropertiesReplaceManagedSynchronizesDeclaredKeys() {
    ...
    User updated =
        IdentityVerificationUserUpdater.update(
                tenant(), user, context(Map.of("kyc_level", "platinum")), resultConfig)
            .updated();
