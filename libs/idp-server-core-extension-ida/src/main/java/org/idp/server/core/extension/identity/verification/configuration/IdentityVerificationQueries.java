...
public class IdentityVerificationQueries implements UuidConvertable {
  Map<String, String> values;

  public IdentityVerificationQueries() {}

  public IdentityVerificationQueries(Map<String, String> values) {
