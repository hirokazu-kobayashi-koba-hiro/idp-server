...
public class IdentityVerificationProcessResultCondition implements JsonReadable {
  ...
  public IdentityVerificationProcessResultCondition(
      String processName, String type, int successCount, int failureCount) {
  ...
  public boolean isGraterEqualSuccessCount(int count) {
    return count >= this.successCount;
  }

  public boolean isGraterEqualFailureCount(int count) {
    return count >= this.failureCount;
  }
