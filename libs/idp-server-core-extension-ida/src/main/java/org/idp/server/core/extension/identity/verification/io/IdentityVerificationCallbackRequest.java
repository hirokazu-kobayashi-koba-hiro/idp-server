...
public class IdentityVerificationCallbackRequest {
  JsonNodeWrapper jsonNodeWrapper;

  public IdentityVerificationCallbackRequest() {}

  public IdentityVerificationCallbackRequest(Map<String, Object> values) {
    this.jsonNodeWrapper = JsonNodeWrapper.fromMap(values);
  }

  public IdentityVerificationCallbackRequest(String jsonString) {
