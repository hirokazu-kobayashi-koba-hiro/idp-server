...
package org.idp.server.core.extension.identity.verification.configuration.post_hook;
...
public class IdentityVerificationPostHookConfig implements JsonReadable {
  ...
  public IdentityVerificationPostHookConfig() {}

  public List<IdentityVerificationConfig> executions() {
    if (executions == null) {
