...
public class IdentityVerificationRegistrationConfiguration implements JsonReadable {
  IdentityVerificationBasicAuthConfiguration basicAuth =
      new IdentityVerificationBasicAuthConfiguration();
  Map<String, Object> requestValidationSchema = new HashMap<>();
  Map<String, Object> requestVerificationSchema = new HashMap<>();

  public IdentityVerificationRegistrationConfiguration() {}

  public IdentityVerificationBasicAuthConfiguration basicAuthConfiguration() {
    return basicAuth;
  }
