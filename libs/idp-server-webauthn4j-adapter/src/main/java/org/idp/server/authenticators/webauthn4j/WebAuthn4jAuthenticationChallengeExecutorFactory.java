...
public class WebAuthn4jAuthenticationChallengeExecutorFactory implements AuthenticationExecutorFactory {
  ...
  public AuthenticationExecutor create(AuthenticationDependencyContainer container) {
    ...
    return new WebAuthn4jAuthenticationChallengeExecutor(
