...
public class NoOperationMdsResolver implements MdsResolver {
  ...
  public AuthenticatorStatus checkStatus(AAGUID aaguid) {
    return AuthenticatorStatus.notFound(aaguid != null ? aaguid.toString() : "unknown");
  }

  @Override
  public AuthenticatorStatus checkStatus(String aaguidString) {
    return AuthenticatorStatus.notFound(aaguidString != null ? aaguidString : "unknown");
  }
