...
public class WebAuthn4jDeregistrationExecutorFactory implements AuthenticationExecutorFactory {
  ...
  public AuthenticationExecutor create(AuthenticationDependencyContainer container) {
    ...
    return new WebAuthn4jDeregistrationExecutor(credentialRepository);
  }
}
