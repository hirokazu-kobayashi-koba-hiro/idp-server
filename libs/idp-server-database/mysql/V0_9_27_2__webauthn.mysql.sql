...
-- Design: Core columns + JSON for extensibility (WebAuthn Level 3+ ready)
...
CREATE INDEX idx_webauthn_backup_eligible ON webauthn_credentials (backup_eligible);
CREATE INDEX idx_webauthn_backup_state ON webauthn_credentials (backup_state);