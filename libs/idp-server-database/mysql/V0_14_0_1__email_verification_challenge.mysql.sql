-- #1416: self-service email verification / change. See the PostgreSQL counterpart for why this is a
...
(
    ...
    PRIMARY KEY (id),
    KEY idx_email_verification_challenge_user (tenant_id, user_id),
    KEY idx_email_verification_challenge_expires_at (expires_at),
