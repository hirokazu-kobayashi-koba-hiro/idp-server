...
COMMENT ON TABLE security_event IS 'Security events are retained for 90 days from created_at. Daily partitions older than 90 days are automatically dropped by scheduled cleanup job.';
