...
COMMENT
ON COLUMN security_event_hook_results.security_event_hook_execution_payload IS
...
CREATE INDEX idx_audit_log_type_created ON audit_log (type, created_at DESC);
