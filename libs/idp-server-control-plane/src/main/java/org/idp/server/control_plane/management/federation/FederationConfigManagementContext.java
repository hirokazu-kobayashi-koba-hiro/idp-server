...
/**
 * Unified context for all federation configuration management operations.
 *
 ...
 * </ul>
 */
public class FederationConfigManagementContext implements AuditableContext {
  ...
  public FederationConfigManagementContext(
      TenantIdentifier tenantIdentifier,
      User operator,
      OAuthToken oAuthToken,
      RequestAttributes requestAttributes,
  ...
  public String description() {
    return "federation configuration management api";
  }
