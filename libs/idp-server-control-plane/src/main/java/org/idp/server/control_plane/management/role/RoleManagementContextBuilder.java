...
/**
 * Builder for RoleManagementContext.
 *
...
public class RoleManagementContextBuilder {
  ...
  private final RoleManagementRequest request;
  private final TenantIdentifier tenantIdentifier;
  private final boolean dryRun;

  private Role before; // nullable: null in error scenarios
  private Role after; // nullable: null in error scenarios
   ...
   *
   * @param before existing role
   * @return this builder
   */
  public RoleManagementContextBuilder withBefore(Role before) {
    this.before = before;
    return this;
  }
   ...
   *
   * @param after new or updated role
   * @return this builder
   */
  public RoleManagementContextBuilder withAfter(Role after) {
    this.after = after;
    return this;
  }

  /**
   * Builds complete RoleManagementContext.
   *
   * @return full context with before/after roles
   */
  public AuditableContext build() {
    return new RoleManagementContext(
        tenantIdentifier,
        operator,
        oAuthToken,
        requestAttributes,
  ...
  /**
   * Builds partial RoleManagementContext for error scenarios.
   *
