...
public class ClientUpdateContext implements AuditableContext {
  Tenant tenant;
  ...
  public ClientConfiguration beforeConfiguration() {
    return before;
  }

  public ClientConfiguration afterConfiguration() {
    return after;
  }
