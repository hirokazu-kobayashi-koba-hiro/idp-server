...
/**
 * Builder for UserFindContext.
 *
 * <p>Allows incremental construction of find context, supporting error scenarios where data
 * retrieval may fail.
 */
public class UserFindContextBuilder implements UserManagementContextBuilder {
  ...
  @Override
  public UserFindContextBuilder withTenant(Tenant tenant) {
    this.tenant = tenant;
  ...
  @Override
  public UserFindContextBuilder withOrganization(Organization organization) {
  ...
  public UserFindContextBuilder withUser(User user) {
    this.user = user;
    return this;
  }

  public UserFindContextBuilder withDryRun(boolean dryRun) {
    this.dryRun = dryRun;
    return this;
  }
  ...
  public AuditableContext build() {
    ...
    return new UserFindContext(tenant, operator, oAuthToken, requestAttributes, user, dryRun);
  }
