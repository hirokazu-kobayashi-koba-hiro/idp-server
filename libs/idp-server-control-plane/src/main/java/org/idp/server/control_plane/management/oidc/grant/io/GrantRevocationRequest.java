...
public class GrantRevocationRequest implements GrantManagementRequest {
  AuthorizationGrantedIdentifier grantIdentifier;

  public GrantRevocationRequest() {}

  public GrantRevocationRequest(AuthorizationGrantedIdentifier grantIdentifier) {
