...
/**
 * Handler for system-level contact verification challenge management operations.
 *
 * <p>Orchestrates contact verification challenge management requests following the Handler/Service
 * pattern.
 *
 * @see ContactVerificationChallengeManagementService
 * @see ContactVerificationChallengeManagementResult
 */
public class ContactVerificationChallengeManagementHandler {
  ...
  private final ContactVerificationChallengeManagementApi api;
  private final TenantQueryRepository tenantQueryRepository;
  LoggerWrapper log = LoggerWrapper.getLogger(ContactVerificationChallengeManagementHandler.class);

  public ContactVerificationChallengeManagementHandler(
      Map<String, ContactVerificationChallengeManagementService<?>> services,
      ContactVerificationChallengeManagementApi api,
  ...
  /**
   * Handles an contact verification challenge management request.
   *
  ...
  public ContactVerificationChallengeManagementResult handle(
    ...
    try {
      ...
      return ContactVerificationChallengeManagementResult.error(
