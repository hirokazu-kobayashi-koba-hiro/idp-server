...
public class SecurityEventHookManagementContext implements AuditableContext {
  ...
  public SecurityEventHookManagementContext(
      TenantIdentifier tenantIdentifier,
      User operator,
      OAuthToken oAuthToken,
      RequestAttributes requestAttributes,
  ...
  @Override
  public String type() {
    return "security_event_hook";
  }

  @Override
  public String description() {
    return "security event hook management api";
  }
