 ...
 *
 * <p>Orchestrates organization-scoped identity verification configuration management requests
 * following the Handler/Service pattern. This handler adds organization-level access control on top
 * of the standard configuration management flow.
 *
...
public class OrgIdentityVerificationConfigManagementHandler {
  ...
  LoggerWrapper log = LoggerWrapper.getLogger(OrgIdentityVerificationConfigManagementHandler.class);

  /**
   * Creates a new organization identity verification configuration management handler.
   *
   * @param services map of operation method names to Service implementations
   * @param api the organization identity verification configuration management API (for permission
   *     definitions)
  ...
  /**
   * Handles an organization-level identity verification configuration management request.
   *
