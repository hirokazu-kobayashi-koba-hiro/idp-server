...
public class IdentityVerificationConfigManagementResult {
  ...
  public static IdentityVerificationConfigManagementResult success(
      AuditableContext context, IdentityVerificationConfigManagementResponse response) {
    return new IdentityVerificationConfigManagementResult(context, null, response);
  }
  ...
  public static IdentityVerificationConfigManagementResult error(
    ...
    return new IdentityVerificationConfigManagementResult(context, exception, null);
  }
