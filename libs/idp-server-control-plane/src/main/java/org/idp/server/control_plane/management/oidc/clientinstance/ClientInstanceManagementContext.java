...
/** Unified context for all client instance management operations. */
public class ClientInstanceManagementContext implements AuditableContext {

  TenantIdentifier tenantIdentifier;
  User operator;
  OAuthToken oAuthToken;
  RequestAttributes requestAttributes;
  ClientInstance before;
  ClientInstance after;
  ClientInstanceManagementRequest request;
  boolean dryRun;
  ManagementApiException exception;

  public ClientInstanceManagementContext(
      TenantIdentifier tenantIdentifier,
      User operator,
      OAuthToken oAuthToken,
      RequestAttributes requestAttributes,
  ...
  public String description() {
    return "client instance management api";
  }
