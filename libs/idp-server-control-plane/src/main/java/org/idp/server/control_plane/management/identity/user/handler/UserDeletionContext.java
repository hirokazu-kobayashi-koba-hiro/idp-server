 ...
 *
 * <p>Holds the user being deleted and audit information for logging purposes.
 */
public class UserDeletionContext implements AuditableContext {
  ...
  @Override
  public String type() {
    return "UserManagementApi.delete";
  }
