...
public class OrganizationInitializeRequestValidator {
  ...
  public OrganizationInitializeRequestValidator(
      OrganizationInitializationRequest request, boolean dryRun) {
  ...
  public OrganizationInitializeRequestValidationResult validate() {
    ...
    if (!organizationResult.isValid()
      ...
      return OrganizationInitializeRequestValidationResult.error(
          organizationResult,
          tenantResult,
    ...
    return OrganizationInitializeRequestValidationResult.success(
        organizationResult,
        tenantResult,
        authorizationServerResult,
        adminUserResult,
