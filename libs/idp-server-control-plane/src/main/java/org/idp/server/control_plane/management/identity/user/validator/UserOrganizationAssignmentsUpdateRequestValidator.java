...
public class UserOrganizationAssignmentsUpdateRequestValidator {

  UserRegistrationRequest request;
  boolean dryRun;
  JsonSchemaValidator schemaValidator;

  public UserOrganizationAssignmentsUpdateRequestValidator(
      UserRegistrationRequest request, boolean dryRun) {
    this.request = request;
    this.dryRun = dryRun;
    this.schemaValidator =
        new JsonSchemaValidator(
            ControlPlaneV1SchemaReader.adminUserOrganizationAssignmentsUpdateSchema());
  }
