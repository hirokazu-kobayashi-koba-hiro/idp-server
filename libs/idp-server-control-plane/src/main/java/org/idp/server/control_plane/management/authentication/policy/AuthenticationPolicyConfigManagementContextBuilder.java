...
/**
 * Builder for AuthenticationPolicyConfigManagementContext.
 *
 ...
 * AuthenticationPolicyConfigManagementContextBuilder builder =
 ...
 * }</pre>
 */
public class AuthenticationPolicyConfigManagementContextBuilder {

  private final User operator;
  private final OAuthToken oAuthToken;
  private final RequestAttributes requestAttributes;
  private final AuthenticationPolicyConfigManagementRequest request;
  private final TenantIdentifier tenantIdentifier;
  private final boolean dryRun;

  private AuthenticationPolicyConfiguration before; // nullable: null in error scenarios
  private AuthenticationPolicyConfiguration after; // nullable: null in error scenarios

  public AuthenticationPolicyConfigManagementContextBuilder(
   ...
   * @return this builder
   */
  public AuthenticationPolicyConfigManagementContextBuilder withBefore(
   ...
   * @return this builder
   */
  public AuthenticationPolicyConfigManagementContextBuilder withAfter(
  ...
  /**
   * Builds complete AuthenticationPolicyConfigManagementContext.
   *
   * @return full context with before/after configurations
   */
  public AuditableContext build() {
    return new AuthenticationPolicyConfigManagementContext(
        tenantIdentifier,
        operator,
        oAuthToken,
        requestAttributes,
  ...
  /**
   * Builds partial AuthenticationPolicyConfigManagementContext for error scenarios.
   *
