...
/**
 * Unified context for all contact verification challenge management operations.
 *
 ...
 * </ul>
 */
public class ContactVerificationChallengeManagementContext implements AuditableContext {
  ...
  public ContactVerificationChallengeManagementContext(
      TenantIdentifier tenantIdentifier,
      User operator,
      OAuthToken oAuthToken,
      RequestAttributes requestAttributes,
  ...
  public ContactVerificationChallenge result() {
    return result;
  }
  ...
  @Override
  public String type() {
    return "contact_verification_challenge";
  }

  @Override
  public String description() {
    return "contact verification challenge management api";
  }
  ...
  public Map<String, Object> after() {
    return result != null ? result.toAuditMap() : Collections.emptyMap();
  }
