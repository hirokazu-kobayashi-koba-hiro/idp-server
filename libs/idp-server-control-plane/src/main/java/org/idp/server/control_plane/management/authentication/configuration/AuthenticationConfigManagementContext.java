...
/**
 * Unified context for all authentication configuration management operations.
 *
 ...
 * </ul>
 *
 * <p>Fields before/after are nullable depending on the operation type.
 */
public class AuthenticationConfigManagementContext implements AuditableContext {
  ...
  public AuthenticationConfigManagementContext(
      TenantIdentifier tenantIdentifier,
      User operator,
      OAuthToken oAuthToken,
      RequestAttributes requestAttributes,
  ...
  public AuthenticationConfiguration beforeConfiguration() {
    return before;
  }

  public AuthenticationConfiguration afterConfiguration() {
    return after;
  }
  ...
  public String description() {
    return "authentication configuration management api";
  }
