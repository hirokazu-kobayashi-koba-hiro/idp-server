...
/**
 * Unified context for all authorization server management operations.
 *
 ...
 * </ul>
 */
public class AuthorizationServerManagementContext implements AuditableContext {
  ...
  public AuthorizationServerManagementContext(
      TenantIdentifier tenantIdentifier,
      User operator,
      OAuthToken oAuthToken,
      RequestAttributes requestAttributes,
  ...
  public AuthorizationServerConfiguration beforeConfiguration() {
    return before;
  }

  public AuthorizationServerConfiguration afterConfiguration() {
    return after;
  }
  ...
  public String description() {
    return "authorization server management api";
  }
