...
/**
 * Unified context for all permission management operations.
 *
 ...
 * </ul>
 */
public class PermissionManagementContext implements AuditableContext {
  ...
  public PermissionManagementContext(
      TenantIdentifier tenantIdentifier,
      User operator,
      OAuthToken oAuthToken,
      RequestAttributes requestAttributes,
  ...
  public String description() {
    return "permission management api";
  }
