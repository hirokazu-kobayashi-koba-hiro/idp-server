...
/**
 * Builder for AuthorizationServerManagementContext.
 *
 ...
 * AuthorizationServerManagementContextBuilder builder =
 *     new AuthorizationServerManagementContextBuilder(...);
 *
 * try {
 *   // 2. Service populates builder during execution
 *   builder.withBefore(currentConfig);
 *   builder.withAfter(updatedConfig);
 *
 ...
 * }</pre>
 */
public class AuthorizationServerManagementContextBuilder {

  private final User operator;
  private final OAuthToken oAuthToken;
  private final RequestAttributes requestAttributes;
  private final AuthorizationServerManagementRequest request;
  private final TenantIdentifier tenantIdentifier;
  private final boolean dryRun;

  private AuthorizationServerConfiguration before; // nullable: null in error scenarios
  private AuthorizationServerConfiguration after; // nullable: null in error scenarios

  public AuthorizationServerManagementContextBuilder(
  ...
  /**
   * Sets the before state (for get/update operations).
   *
   * @param before existing authorization server configuration
   * @return this builder
   */
  public AuthorizationServerManagementContextBuilder withBefore(
  ...
  /**
   * Sets the after state (for update operations).
   *
   * @param after updated authorization server configuration
   * @return this builder
   */
  public AuthorizationServerManagementContextBuilder withAfter(
  ...
  /**
   * Builds complete AuthorizationServerManagementContext.
   *
   * @return full context with before/after configurations
   */
  public AuditableContext build() {
    return new AuthorizationServerManagementContext(
        tenantIdentifier,
        operator,
        oAuthToken,
        requestAttributes,
  ...
  /**
   * Builds partial AuthorizationServerManagementContext for error scenarios.
   *
