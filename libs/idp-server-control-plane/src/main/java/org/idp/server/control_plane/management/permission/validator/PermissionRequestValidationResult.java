...
public class PermissionRequestValidationResult {

  boolean isValid;
  JsonSchemaValidationResult validationResult;
  boolean dryRun;

  public static PermissionRequestValidationResult success(
      JsonSchemaValidationResult adminUserResult, boolean dryRun) {
    return new PermissionRequestValidationResult(true, adminUserResult, dryRun);
  }

  private PermissionRequestValidationResult(
  ...
  public static PermissionRequestValidationResult error(
      JsonSchemaValidationResult adminUserResult, boolean dryRun) {
    return new PermissionRequestValidationResult(false, adminUserResult, dryRun);
  }
