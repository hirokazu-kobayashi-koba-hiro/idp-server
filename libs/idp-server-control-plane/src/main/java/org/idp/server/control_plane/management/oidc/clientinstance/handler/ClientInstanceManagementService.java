...
/** Service contract for a single client instance management operation. */
public interface ClientInstanceManagementService<T> {

  ClientInstanceManagementResponse execute(
