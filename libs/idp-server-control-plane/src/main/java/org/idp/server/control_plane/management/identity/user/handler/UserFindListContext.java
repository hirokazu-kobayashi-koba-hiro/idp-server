...
/**
 * Context for user findList (search) operations.
 *
 * <p>Holds the search queries and audit information for logging purposes.
 */
public class UserFindListContext implements AuditableContext {
  ...
  @Override
  public String type() {
    return "UserManagementApi.findList";
  }
  ...
  public Map<String, Object> request() {
    ...
    requestMap.put("limit", queries.limit());
    requestMap.put("offset", queries.offset());
    return requestMap;
  }
