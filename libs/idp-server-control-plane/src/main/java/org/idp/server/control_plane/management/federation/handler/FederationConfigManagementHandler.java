 ...
 *
 * <p>Orchestrates federation configuration management operations following the Handler/Service
 * pattern. Responsibilities include:
 *
 * <ul>
...
public class FederationConfigManagementHandler {
  ...
  LoggerWrapper log = LoggerWrapper.getLogger(FederationConfigManagementHandler.class);

  /**
   * Creates a new federation configuration management handler.
   *
   * @param services map of operation method names to Service implementations
   * @param api the federation configuration management API (for permission definitions)
  ...
  /**
   * Handles a federation configuration management request.
   *
