...
public class OrganizationInitializationContext {
  ...
  public OrganizationInitializationContext(
      Tenant tenant,
      AuthorizationServerConfiguration authorizationServerConfiguration,
      Organization organization,
      Permissions permissions,
  ...
  public OrganizationInitializationResponse toResponse() {
    ...
    return new OrganizationInitializationResponse(
        OrganizationInitializationStatus.CREATED, contents);
  }
}
