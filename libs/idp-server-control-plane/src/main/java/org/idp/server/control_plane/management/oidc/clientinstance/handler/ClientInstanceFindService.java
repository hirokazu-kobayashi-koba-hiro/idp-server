...
/** Returns a single registered Client Instance. */
public class ClientInstanceFindService
  ...
  public ClientInstanceFindService(ClientInstanceQueryRepository queryRepository) {
  ...
  public ClientInstanceManagementResponse execute(
    ...
    return new ClientInstanceManagementResponse(
        ClientInstanceManagementStatus.OK, clientInstance.toMap());
  }
}
