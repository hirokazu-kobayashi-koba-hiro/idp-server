...
/**
 * Unified context for all identity verification configuration management operations.
 *
 ...
 * </ul>
 */
public class IdentityVerificationConfigManagementContext implements AuditableContext {
  ...
  public IdentityVerificationConfigManagementContext(
      TenantIdentifier tenantIdentifier,
      User operator,
      OAuthToken oAuthToken,
      RequestAttributes requestAttributes,
  ...
  public String description() {
    return "identity verification configuration management api";
  }
