...
/**
 * Service interface for contact verification challenge management operations.
 *
 * <p>Part of Handler/Service pattern. Implementations handle specific contact verification
 * challenge management operations (get, findList).
 *
 ...
 */
public interface ContactVerificationChallengeManagementService<T> {

  /**
   * Executes the contact verification challenge management operation.
   *
   ...
   */
  ContactVerificationChallengeManagementResponse execute(
