...
/**
 * Unified context for all audit log management operations.
 *
 ...
 * </ul>
 */
public class AuditLogManagementContext implements AuditableContext {
  ...
  public AuditLogManagementContext(
      TenantIdentifier tenantIdentifier,
      User operator,
      OAuthToken oAuthToken,
      RequestAttributes requestAttributes,
  ...
  public String description() {
    return "audit log management api";
  }
