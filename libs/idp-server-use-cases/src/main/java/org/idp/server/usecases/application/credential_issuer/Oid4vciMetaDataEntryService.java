...
public class Oid4vciMetaDataEntryService implements Oid4vciMetaDataApi {

  TenantQueryRepository tenantQueryRepository;
  Oid4vciProtocols oid4vciProtocols;

  public Oid4vciMetaDataEntryService(
  ...
  @Override
  public CredentialIssuerMetadataResponse getMetadata(TenantIdentifier tenantIdentifier) {
    Tenant tenant = tenantQueryRepository.get(tenantIdentifier);
    Oid4vciProtocol protocol = oid4vciProtocols.get(tenant.authorizationProvider());
    return protocol.getMetadata(tenant);
  }
}
