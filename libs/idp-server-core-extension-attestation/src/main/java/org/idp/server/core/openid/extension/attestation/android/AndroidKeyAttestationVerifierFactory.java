...
/**
 * Builds {@link AndroidKeyAttestationVerifier}.
 *
 * <p>Takes nothing from the container yet: every check the verifier makes is decided by the
 * certificate chain in the request. The attestation status list (Issue #1890) is the one that is
 * not, and it is what the container exists for.
 */
public class AndroidKeyAttestationVerifierFactory implements PlatformAttestationVerifierFactory {

  @Override
  public PlatformAttestationVerifier create(
