...
public class UntrustedIpSignalEvaluator implements RiskSignalEvaluator {

  @Override
  public RiskSignalType signalType() {
    return RiskSignalType.UNTRUSTED_IP;
  }

  @Override
  public RiskSignalResult evaluate(
      Tenant tenant, User user, RequestAttributes requestAttributes, RiskAssessmentConfig config) {
    return new RiskSignalResult(RiskSignalType.UNTRUSTED_IP, 0.0, "not evaluated");
  }
}
