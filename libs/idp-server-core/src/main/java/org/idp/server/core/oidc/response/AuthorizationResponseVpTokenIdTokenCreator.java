...
public class AuthorizationResponseVpTokenIdTokenCreator implements AuthorizationResponseCreator, VpTokenCreatable, IdTokenCreatable, RedirectUriDecidable, JarmCreatable {
  ...
  public AuthorizationResponse create(OAuthAuthorizeContext context) {
    ...
    IdTokenCustomClaims idTokenCustomClaims = new IdTokenCustomClaimsBuilder().add(authorizationRequest.state()).add(authorizationRequest.nonce()).build();
    ...
    AuthorizationResponseBuilder authorizationResponseBuilder = new AuthorizationResponseBuilder(decideRedirectUri(authorizationRequest, context.clientConfiguration()), context.responseMode(), ResponseModeValue.fragment(), context.tokenIssuer()).add(vpToken).add(authorizationGrant.scopes()).add(idToken);
