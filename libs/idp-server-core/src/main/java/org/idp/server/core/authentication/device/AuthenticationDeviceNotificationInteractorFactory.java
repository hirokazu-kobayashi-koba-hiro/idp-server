...
public class AuthenticationDeviceNotificationInteractorFactory implements AuthenticationInteractorFactory {
  ...
  public AuthenticationInteractor create(AuthenticationDependencyContainer container) {
    ...
    AuthenticationDeviceNotifiers authenticationDeviceNotifiers = container.resolve(AuthenticationDeviceNotifiers.class);
    ...
    return new AuthenticationDeviceNotificationInteractor(authenticationDeviceNotifiers, configurationQueryRepository);
  }
}
