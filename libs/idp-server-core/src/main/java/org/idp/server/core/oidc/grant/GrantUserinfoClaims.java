...
public class GrantUserinfoClaims implements Iterable<String> {
  ...
  public static GrantUserinfoClaims create(Scopes scopes, List<String> supportedClaims, RequestedUserinfoClaims userinfoClaims) {
    Set<String> claims = new HashSet<>();
    if (shouldAddName(scopes, supportedClaims, userinfoClaims))
      claims.add("name");
    if (shouldAddGivenName(scopes, supportedClaims, userinfoClaims))
      claims.add("given_name");
    if (shouldAddFamilyName(scopes, supportedClaims, userinfoClaims))
      claims.add("family_name");
    if (shouldAddMiddleName(scopes, supportedClaims, userinfoClaims))
      claims.add("middle_name");
    if (shouldAddNickname(scopes, supportedClaims, userinfoClaims))
      claims.add("nickname");
    if (shouldAddPreferredUsername(scopes, supportedClaims, userinfoClaims))
      claims.add("preferred_username");
    if (shouldAddProfile(scopes, supportedClaims, userinfoClaims))
      claims.add("profile");
    if (shouldAddPicture(scopes, supportedClaims, userinfoClaims))
      claims.add("picture");
    if (shouldAddWebsite(scopes, supportedClaims, userinfoClaims))
      claims.add("website");
    if (shouldAddEmail(scopes, supportedClaims, userinfoClaims))
      claims.add("email");
    if (shouldAddEmailVerified(scopes, supportedClaims, userinfoClaims))
      claims.add("email_verified");
    if (shouldAddGender(scopes, supportedClaims, userinfoClaims))
      claims.add("gender");
    if (shouldAddBirthdate(scopes, supportedClaims, userinfoClaims))
      claims.add("birthdate");
    if (shouldAddZoneinfo(scopes, supportedClaims, userinfoClaims))
      claims.add("zoneinfo");
    if (shouldAddLocale(scopes, supportedClaims, userinfoClaims))
      claims.add("locale");
    if (shouldAddPhoneNumber(scopes, supportedClaims, userinfoClaims))
    ...
    if (shouldAddAddress(scopes, supportedClaims, userinfoClaims))
      claims.add("address");
    if (shouldAddUpdatedAt(scopes, supportedClaims, userinfoClaims))
  ...
  private static boolean shouldAddName(Scopes scopes, List<String> supportedClaims, RequestedUserinfoClaims userinfoClaims) {
  ...
  private static boolean shouldAddGivenName(Scopes scopes, List<String> supportedClaims, RequestedUserinfoClaims userinfoClaims) {
  ...
  private static boolean shouldAddFamilyName(Scopes scopes, List<String> supportedClaims, RequestedUserinfoClaims userinfoClaims) {
  ...
  private static boolean shouldAddMiddleName(Scopes scopes, List<String> supportedClaims, RequestedUserinfoClaims userinfoClaims) {
  ...
  private static boolean shouldAddNickname(Scopes scopes, List<String> supportedClaims, RequestedUserinfoClaims userinfoClaims) {
  ...
  private static boolean shouldAddPreferredUsername(Scopes scopes, List<String> supportedClaims, RequestedUserinfoClaims userinfoClaims) {
  ...
  private static boolean shouldAddProfile(Scopes scopes, List<String> supportedClaims, RequestedUserinfoClaims userinfoClaims) {
  ...
  private static boolean shouldAddPicture(Scopes scopes, List<String> supportedClaims, RequestedUserinfoClaims userinfoClaims) {
  ...
  private static boolean shouldAddWebsite(Scopes scopes, List<String> supportedClaims, RequestedUserinfoClaims userinfoClaims) {
  ...
  private static boolean shouldAddEmail(Scopes scopes, List<String> supportedClaims, RequestedUserinfoClaims userinfoClaims) {
  ...
  private static boolean shouldAddEmailVerified(Scopes scopes, List<String> supportedClaims, RequestedUserinfoClaims userinfoClaims) {
  ...
  private static boolean shouldAddGender(Scopes scopes, List<String> supportedClaims, RequestedUserinfoClaims userinfoClaims) {
  ...
  private static boolean shouldAddBirthdate(Scopes scopes, List<String> supportedClaims, RequestedUserinfoClaims userinfoClaims) {
  ...
  private static boolean shouldAddZoneinfo(Scopes scopes, List<String> supportedClaims, RequestedUserinfoClaims userinfoClaims) {
  ...
  private static boolean shouldAddLocale(Scopes scopes, List<String> supportedClaims, RequestedUserinfoClaims userinfoClaims) {
  ...
  private static boolean shouldAddPhoneNumber(Scopes scopes, List<String> supportedClaims, RequestedUserinfoClaims userinfoClaims) {
  ...
  private static boolean shouldAddPhoneNumberVerified(Scopes scopes, List<String> supportedClaims, RequestedUserinfoClaims userinfoClaims) {
  ...
  private static boolean shouldAddAddress(Scopes scopes, List<String> supportedClaims, RequestedUserinfoClaims userinfoClaims) {
  ...
  private static boolean shouldAddUpdatedAt(Scopes scopes, List<String> supportedClaims, RequestedUserinfoClaims userinfoClaims) {
