...
public class UserUpdater {
  ...
  public User update() {
    ...
    if (user.hasGivenName())
      updatedUser.setGivenName(user.givenName());
    if (user.hasFamilyName())
      updatedUser.setFamilyName(user.familyName());
    if (user.hasMiddleName())
      updatedUser.setMiddleName(user.middleName());
    if (user.hasNickname())
      updatedUser.setNickname(user.nickname());
    if (user.hasPreferredUsername())
      updatedUser.setPreferredUsername(user.preferredUsername());
    if (user.hasProfile())
      updatedUser.setProfile(user.profile());
    if (user.hasPicture())
      updatedUser.setPicture(user.picture());
    if (user.hasWebsite())
      updatedUser.setWebsite(user.website());
    if (user.hasEmail())
      updatedUser.setEmail(user.email());
    if (user.hasEmailVerified())
      updatedUser.setEmailVerified(user.emailVerified());
    if (user.hasGender())
      updatedUser.setGender(user.gender());
    if (user.hasBirthdate())
      updatedUser.setBirthdate(user.birthdate());
    if (user.hasZoneinfo())
      updatedUser.setZoneinfo(user.zoneinfo());
    if (user.hasLocale())
      updatedUser.setLocale(user.locale());
    ...
    if (user.hasUpdatedAt())
      updatedUser.setUpdatedAt(user.updatedAt());
    if (user.hasAddress())
      updatedUser.setAddress(user.address());
    if (user.hasCustomProperties())
      updatedUser.setCustomProperties(user.customPropertiesValue());
