...
public class DefaultTokenIntrospectionProtocol implements TokenIntrospectionProtocol {

  TokenIntrospectionHandler handler;
  Logger log = Logger.getLogger(DefaultTokenIntrospectionProtocol.class.getName());

  public DefaultTokenIntrospectionProtocol(OAuthTokenRepository oAuthTokenRepository) {
