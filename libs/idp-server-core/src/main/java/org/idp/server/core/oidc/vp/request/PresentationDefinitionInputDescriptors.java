 ...
 *
 * <p>
 * Input Descriptor Objects contain an identifier and may contain constraints on data values, and an
 * explanation why a certain item or set of data is being requested.
 *
 * @see <a href=
 *      "https://identity.foundation/presentation-exchange/spec/v2.0.0/#input-descriptor">input-descriptor</a>
 */
