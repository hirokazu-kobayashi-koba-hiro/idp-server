...
public class UserUpdater {
    ...
    public User update() {
        ...
        if (user.hasProviderOriginalPayload()) updatedUser.setProviderOriginalPayload(user.providerOriginalPayload());
        ...
        if (user.hasPhoneNumberVerified()) updatedUser.setPhoneNumberVerified(user.phoneNumberVerified());
