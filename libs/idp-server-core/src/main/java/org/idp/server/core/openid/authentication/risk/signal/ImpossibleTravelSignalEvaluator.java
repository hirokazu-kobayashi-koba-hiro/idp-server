...
public class ImpossibleTravelSignalEvaluator implements RiskSignalEvaluator {

  @Override
  public RiskSignalType signalType() {
    return RiskSignalType.IMPOSSIBLE_TRAVEL;
  }

  @Override
  public RiskSignalResult evaluate(
      Tenant tenant, User user, RequestAttributes requestAttributes, RiskAssessmentConfig config) {
    return new RiskSignalResult(RiskSignalType.IMPOSSIBLE_TRAVEL, 0.0, "not evaluated");
  }
}
