...
public class AuthenticationExecutionRequest {

  private static final LoggerWrapper log =
      LoggerWrapper.getLogger(AuthenticationExecutionRequest.class);
  ...
  public AuthenticationExecutionRequest() {}

  public AuthenticationExecutionRequest(Map<String, Object> values) {
    this.values = values;
  }
  ...
  public AuthenticationExecutionRequest add(String key, Object value) {
    HashMap<String, Object> map = new HashMap<>(values);
    map.put(key, value);
    return new AuthenticationExecutionRequest(map);
  }
