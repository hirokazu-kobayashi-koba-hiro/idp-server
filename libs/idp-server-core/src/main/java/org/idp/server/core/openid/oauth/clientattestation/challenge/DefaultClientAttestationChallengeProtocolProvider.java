...
public class DefaultClientAttestationChallengeProtocolProvider
    implements ProtocolProvider<ClientAttestationChallengeProtocol> {

  @Override
  public Class<ClientAttestationChallengeProtocol> type() {
    return ClientAttestationChallengeProtocol.class;
  }

  @Override
  public ClientAttestationChallengeProtocol provide(ApplicationComponentContainer container) {
