...
public class ServerConfigurationResponseCreator {
  ...
  public Map<String, Object> create() {
    ...
    map.put("id_token_signing_alg_values_supported", serverConfiguration.idTokenSigningAlgValuesSupported());
    if (serverConfiguration.hasIdTokenEncryptionEncValuesSupported()) {
      map.put("id_token_encryption_alg_values_supported", serverConfiguration.idTokenEncryptionEncValuesSupported());
    }
    if (serverConfiguration.hasIdTokenEncryptionEncValuesSupported()) {
      map.put("id_token_encryption_enc_values_supported", serverConfiguration.idTokenEncryptionEncValuesSupported());
    }
    if (serverConfiguration.hasUserinfoSigningAlgValuesSupported()) {
      map.put("userinfo_signing_alg_values_supported", serverConfiguration.userinfoSigningAlgValuesSupported());
    }
    if (serverConfiguration.hasUserinfoEncryptionAlgValuesSupported()) {
      map.put("userinfo_encryption_alg_values_supported", serverConfiguration.userinfoEncryptionAlgValuesSupported());
    }
    if (serverConfiguration.hasUserinfoEncryptionEncValuesSupported()) {
      map.put("userinfo_encryption_enc_values_supported", serverConfiguration.userinfoEncryptionEncValuesSupported());
    }
    if (serverConfiguration.hasRequestObjectSigningAlgValuesSupported()) {
      map.put("request_object_signing_alg_values_supported", serverConfiguration.requestObjectSigningAlgValuesSupported());
    }
    if (serverConfiguration.hasRequestObjectEncryptionAlgValuesSupported()) {
      map.put("request_object_encryption_alg_values_supported", serverConfiguration.requestObjectEncryptionAlgValuesSupported());
    }
    ...
    if (serverConfiguration.hasTokenEndpointAuthMethodsSupported()) {
      map.put("token_endpoint_auth_methods_supported", serverConfiguration.tokenEndpointAuthMethodsSupported());
    }
    if (serverConfiguration.hasTokenEndpointAuthSigningAlgValuesSupported()) {
      map.put("token_endpoint_auth_signing_alg_values_supported", serverConfiguration.tokenEndpointAuthMethodsSupported());
    }
    ...
    map.put("require_request_uri_registration", serverConfiguration.requireRequestUriRegistration());
