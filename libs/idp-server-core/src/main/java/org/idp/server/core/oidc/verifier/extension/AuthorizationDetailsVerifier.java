...
public class AuthorizationDetailsVerifier {
  ...
  public AuthorizationDetailsVerifier(AuthorizationDetails authorizationDetails, ServerConfiguration serverConfiguration, ClientConfiguration clientConfiguration) {
