...
public class DefaultCibaProtocolProvider implements ProtocolProvider<CibaProtocol> {
  ...
  public CibaProtocol provide(ApplicationComponentContainer container) {
    ...
    return new DefaultCibaProtocol(backchannelAuthenticationRequestRepository, cibaGrantRepository, userQueryRepository, authorizationGrantedRepository, oAuthTokenRepository, serverConfigurationRepository, clientConfigurationRepository);
  }
}
