package org.idp.server.core.token.tokenrevocation.exception;
...
public class TokenRevocationBadRequestException extends RuntimeException {
  ...
  public TokenRevocationBadRequestException(String error, String errorDescription, Throwable throwable) {
