...
/** Request body of the self-service contact endpoints (Issue #1416). */
public class ContactVerificationRequest {
  ...
  public ContactVerificationRequest(Map<String, Object> values) {
  ...
  /**
   * Reads {@code new_value} as a string.
   *
  ...
  public String newValue() {
    Object value = values.get("new_value");
