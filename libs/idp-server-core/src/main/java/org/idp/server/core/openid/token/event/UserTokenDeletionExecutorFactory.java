...
package org.idp.server.core.openid.token.event;
...
public class UserTokenDeletionExecutorFactory implements UserLifecycleEventExecutorFactory {
  ...
  public UserLifecycleEventExecutor create(
    ...
    return new UserTokenDeletionExecutor(oAuthTokenOperationCommandRepository);
  }
}
