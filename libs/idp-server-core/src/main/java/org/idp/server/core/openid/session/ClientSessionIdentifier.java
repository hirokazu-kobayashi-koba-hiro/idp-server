...
public class ClientSessionIdentifier {
  ...
  public ClientSessionIdentifier(String value) {
    this.value = value;
  }

  public static ClientSessionIdentifier generate() {
    ...
    return new ClientSessionIdentifier(PREFIX + encoded);
  }
  ...
  public boolean equals(Object o) {
    ...
    ClientSessionIdentifier that = (ClientSessionIdentifier) o;
