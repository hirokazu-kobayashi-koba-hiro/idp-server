...
- `documentation/openapi/swagger-cp-tenant-ja.yaml` - OpenAPI仕様（テナント管理APIスキーマ）
...
- `spec-session` - セッション管理の詳細
- `dev-control-plane` - 管理API全般
- `ops-local-env` - ローカル開発環境
