...
export const options = {
  scenarios: {
    peakLoad: {
      ...
      startRate: 100, // Initial request rate (requests per second)
      timeUnit: '1s',
      preAllocatedVUs: 50, // Minimum number of VUs to pre-allocate
      maxVUs: 100,         // Maximum number of VUs allowed
      stages: [
        { target: 120, duration: '3m' }, // Ramp-up phase
        { target: 120, duration: '5m' }, // Sustained peak phase
