...
主要ファイル:
- `libs/idp-server-database/postgresql/V0_10_1__statistics_events_bucket_distribution.sql` — `CREATE TABLE statistics_event_buckets`
- `libs/idp-server-database/mysql/V0_10_1__statistics_events_bucket_distribution.mysql.sql` — MySQL 版
...
- 新マイグレーション `V0_10_1`: `CREATE TABLE statistics_event_buckets` のみ (データコピーは含めない)
- アプリコード:
