...
export ALLOW_ORIGINS='"'"${UI_BASE_URL}"'","https://api.local.test","http://localhost:3000","http://localhost:3100","http://localhost:5173","https://idp-auth-frontend-ecru.vercel.app","https://idp-auth-frontend-diqt.vercel.app"'
