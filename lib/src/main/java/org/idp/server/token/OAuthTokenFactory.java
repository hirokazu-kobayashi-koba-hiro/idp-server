...
public class OAuthTokenFactory {
  ...
  public static OAuthToken create(AuthorizationResponse authorizationResponse) {
    ...
    return new OAuthToken(oAuthTokenIdentifier, tokenResponse, accessTokenPayload);
  }
}
