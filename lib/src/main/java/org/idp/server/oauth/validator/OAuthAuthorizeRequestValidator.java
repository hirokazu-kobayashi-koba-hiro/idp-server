...
public class OAuthAuthorizeRequestValidator {
    ...
    public OAuthAuthorizeRequestValidator(TokenIssuer tokenIssuer, AuthorizationRequestIdentifier authorizationRequestIdentifier, User user, Authentication authentication, CustomProperties customProperties) {
