...
public class AuthorizationCodeGrant {
    ...
    public AuthorizationCodeGrant(AuthorizationRequestIdentifier authorizationRequestIdentifier, AuthorizationCode authorizationCode, ExpiresDateTime expiresDateTime) {
