...
public class AuthorizationErrorResponseBuilder {
    ...
    public AuthorizationErrorResponseBuilder(RedirectUri redirectUri, ResponseModeValue responseModeValue, TokenIssuer tokenIssuer) {
    ...
    public AuthorizationErrorResponse build() {
        return new AuthorizationErrorResponse(redirectUri, responseModeValue, state, tokenIssuer, error, errorDescription, queryParams);
    }
}
