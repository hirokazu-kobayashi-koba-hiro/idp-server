...
VALUES
('9eb8eb8c-2615-4604-809f-5cae1c00a462', 'admin', 'admin-organization'),
('343a2413-b2e4-471e-a19f-957cd1598137', 'unsupported', 'unsupported-organization')
;

INSERT INTO public.tenant (id, name, type, issuer)
VALUES
('67e7eae6-62b0-4500-9eff-87459f63fc66', 'admin', 'ADMIN', 'http://localhost:8080/67e7eae6-62b0-4500-9eff-87459f63fc66'),
('94d8598e-f238-4150-85c2-c4accf515784', 'unsupported', 'PUBLIC', 'http://localhost:8080/94d8598e-f238-4150-85c2-c4accf515784');

INSERT INTO public.organization_tenants(id, organization_id, tenant_id)
VALUES
('6ae408f9-297b-4a3f-a8f4-1b77eb07b1af', '9eb8eb8c-2615-4604-809f-5cae1c00a462', '67e7eae6-62b0-4500-9eff-87459f63fc66'),
('115d8e02-7772-4be3-a618-67d70546d3d1', '343a2413-b2e4-471e-a19f-957cd1598137', '94d8598e-f238-4150-85c2-c4accf515784');
...
INSERT INTO public.idp_user (id, tenant_id, name, given_name, family_name, middle_name, nickname, preferred_username,
                           ...
                           phone_number, phone_number_verified, address, custom_properties, credentials, hashed_password,
...
VALUES ('3ec055a8-8000-44a2-8677-e70ebff414e2', '67e7eae6-62b0-4500-9eff-87459f63fc66', 'ito ichiro', 'ichiro', 'ito', 'mac', 'ito', 'ichiro', 'https://example.com/profiles/123',
        ...
        '$2a$10$EqSprnKhTncdGrsLte6hTuzNiNDdTlo2571ZPy11G9dJXaRBCrale', '2023-08-03 23:44:20.259371', '2023-08-03 23:44:20.259371');
