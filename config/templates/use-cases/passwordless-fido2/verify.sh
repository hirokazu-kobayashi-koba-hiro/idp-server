...
# Passwordless (FIDO2/WebAuthn) - Verification Script
#
...
#   5. Token Refresh
#
# Note: FIDO2 authentication requires browser interaction and cannot be
# fully verified via CLI. This script verifies the password fallback path.
#
# Prerequisites:
...
echo "=========================================="
echo "Passwordless (FIDO2/WebAuthn) Verification"
echo "=========================================="
echo ""
