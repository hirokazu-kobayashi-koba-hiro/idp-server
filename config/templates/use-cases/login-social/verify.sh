...
# Login (Social) - Verification Script
#
...
#   5. Token Refresh
#
# Note: Social login (Google) cannot be verified automatically.
#       This script verifies the password-based flow only.
#
# Prerequisites:
...
echo "=========================================="
echo "Login (Social) Verification"
echo "=========================================="
echo ""
