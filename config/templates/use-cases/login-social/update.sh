...
# Login (Social) - Use Case Update Script
# Updates public tenant, authorization server, client, and federation settings.
#
# Usage:
#   ./update.sh
...
echo "=========================================="
echo "Login (Social) Use Case Update"
echo "=========================================="
...
FEDERATION_JSON=$(cat "${OUTPUT_DIR}/federation-config.json")
