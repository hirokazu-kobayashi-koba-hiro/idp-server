...
ORGANIZATION_NAME="${ORGANIZATION_NAME:-financial-grade-2.0}"
...
FINANCIAL_TENANT_JSON=$(substitute_template "${SCRIPT_DIR}/fapi2-tenant-template.json" \
...
TLS_CLIENT_JSON=$(substitute_template "${SCRIPT_DIR}/mtls-client-template.json" \
...
PKJ_CLIENT_JSON=$(substitute_template "${SCRIPT_DIR}/dpop-client-template.json" \
