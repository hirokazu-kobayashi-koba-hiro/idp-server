...
# tenant
export TENANT_ID=$ADMIN_TENANT_ID
...
export AUTHORIZATION_SERVER_URL=$BASE_URL
...
export ADMIN_USER_NAME=$ADMIN_USERNAME
...
export ADMIN_CLIENT_ID_ALIAS=$ADMIN_CLIENT_ID_ALIAS
...
envsubst < ./config-templates/admin/initial.json > ./config-sample/local/admin-tenant/initial.json