...
# Passwordless (FIDO2/WebAuthn) Example - Verification Script
#
# Verifies that the example environment works correctly by performing:
#   1. Discovery endpoint check
#   2. Authorization request
#   3. User registration via initial-registration (password fallback)
#   4. Consent grant (authorize)
#   5. Token exchange (authorization code → tokens)
#   6. UserInfo endpoint verification
#   7. Token Refresh
#
# Note: FIDO2/WebAuthn authentication requires browser interaction and cannot
#       be fully verified via CLI. This script verifies the password fallback
#       path using initial-registration.
#
# Prerequisites:
...
echo "=========================================="
echo "Passwordless (FIDO2/WebAuthn) Example Verification"
echo "=========================================="
echo ""
...
# ============================================================
echo "Step 3: Registering test user (initial-registration, password fallback)..."
...
echo "      To test FIDO2 manually, open:"
