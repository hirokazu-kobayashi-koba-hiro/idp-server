...
#server
curl -X POST "${IDP_SERVER_DOMAIN}67e7eae6-62b0-4500-9eff-87459f63fc66/api/v1/admin/server/registration" \
...
#client
curl -X POST "${IDP_SERVER_DOMAIN}67e7eae6-62b0-4500-9eff-87459f63fc66/api/v1/admin/client/registration" \
-u "${IDP_SERVER_API_KEY}:${IDP_SERVER_API_SECRET}" \
-H "Content-Type:application/json" \
